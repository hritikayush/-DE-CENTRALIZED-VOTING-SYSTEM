        ...
        return (
            <Layout>
                <div className="h-screen bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-gray-900 to-gray-600 ">
                    <div className="text-5xl text-center font-bold text-slate-200 ">
                        <h1>Teams List</h1>
                    </div>

                    <div className="text-xl border-solid border-2 rounded-lg border-black p-10 bg-gradient-to-bl from-gray-700 via-gray-900 to-black">
                    <Table>
                        <Header>
                            <Row>
                    ...
                    <div className="font-xl flex justify-center h-20">
                        <Link route={`/events/${this.props.address}/teams/new`}>
                            <a>
                                <button className="flex justify-center mx-auto rounded-lg cursor-pointer p-2 mt-5 text-white font-semibold px-6 py-3 h-12 w-48 
                    bg-gradient-to-r from-blue-600 via-blue-700 to-blue-900 hover:from-pink-500 hover:to-yellow-500" >Add your team !</button>
                            </a>
                        </Link>
                    </div>

                    <div className="text-center font-semibold text-4xl text-slate-100">
                        <div>
                        <h2>Number of teams currently : {this.props.teamsCount} .</h2>
                        </div>
                        </div>
                    <div className="flex flex-auto justify-center text-3xl mt-48 h-20 bg-slate-400">
                        <h1 className="pt-5 mr-4">Click here to close voting : </h1>
                        <button className="my-2 p-3 rounded-lg cursor-pointer animate-pulse delay-300 text-white font-semibold
                    bg-gradient-to-r from-red-600 to-gray-700 hover:from-pink-500 hover:to-yellow-500" onClick={this.onClose}>Close Voting!</button>
                        ...
                        <div className="flex flex-auto justify-center text-3xl my-4">
